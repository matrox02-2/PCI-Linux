...
#dmesg 2>&1 >> $HOSTNAME-SystemInfo.txt
echo "--------------------" >> $HOSTNAME-SystemInfo.txt
...
echo "--------------------" >> $HOSTNAME-SystemInfo.txt
echo "Display memory information" >> $HOSTNAME-SystemInfo.txt || less /proc/cpuinfo 2>&1 >> $HOSTNAME-SystemInfo.txt
...
echo  "|= Related requirements: 1.1a                                                =|" >>   $HOSTNAME-Requirement-1.txt 
#echo "|=---------------------------------------------------------------------------=|" >>   $HOSTNAME-Requirement-1.txt 
...
cat /etc/vsftpd/vsftpd.conf | grep -v "#" >> $HOSTNAME-Requirement-1.txt 2>&1
...
cat /etc/mail/sendmail.cf | grep -v "#" >> $HOSTNAME-Requirement-1.txt 2>&1
echo "===============================================" >>$HOSTNAME-Requirement-1.txt
echo "Checking postfix configuration" >> $HOSTNAME-Requirement-1.txt
cat /etc/postfix/main.cf | grep -v "#" >> $HOSTNAME-Requirement-1.txt 2>&1
...
cat /etc/http/httpd.conf | grep -v "#" >> $HOSTNAME-Requirement-1.txt 2>&1
...
cat /etc/snmp/snmp.conf | grep -v "#" >> $HOSTNAME-Requirement-1.txt 2>&1
...
cat /etc/sysctl.conf | grep -v "#" >>$HOSTNAME-Requirement-1.txt 2>&1
echo "=======================================================================" >> $HOSTNAME-Requirement-1.txt
...
egrep -w 'ESTABLISHED' /etc/iptables.up.rules >>$HOSTNAME-Requirement-1.txt 2>&1 || egrep -w 'ESTABLISHED' /etc/sysconfig/iptables >>$HOSTNAME-Requirement-1.txt 2>&1
...
cat /etc/iptables.up.rules | grep -v "#" >> $HOSTNAME-Requirement-1.txt 2>&1  || cat /etc/sysconfig/iptbles | grep -v "#" >> $HOSTNAME-Requirement-1.txt 2>&1 
...
crontab -l | grep *clamav* >> $HOSTNAME-Requirement-5.txt 2>&1
echo "===============================================" >>$HOSTNAME-Requirement-5.txt
...
cat /var/log/yum.log | grep -v "#" >> $HOSTNAME-Requirement-6.txt 2>&1 || cat var/log/apt/history.log | grep -v "#" >> $HOSTNAME-Requirement-6.txt 2>&1
...
rpm -qa 2>&1 | egrep -w 'selinux-basic|selinux-policy-defualt' >> $HOSTNAME-Requirement-7.txt || dpkg -l | grep selinux*
...
echo "|=----------------------------------------------------------------------------=|" >>   $HOSTNAME-Requirement-10.txt 
sudo cat /etc/ntp.conf | grep -v "#" >> $HOSTNAME-Requirement-10.txt 2>&1 || sudo cat /etc/default/ntpdate | grep -v "#" >> $HOSTNAME-Requirement-10.txt 2>&1 || sudo cat /etc/xntp.conf | grep -v "#" >> $HOSTNAME-Requirement-10.txt 2>&1
echo "" >>   $HOSTNAME-Requirement-10.txt
